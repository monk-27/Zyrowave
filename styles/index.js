const styles = {
  ...
  servicescard:"mt-2 flex flex-col items-center h-72 bg-white border border-gray-200 rounded-lg shadow md:flex-row w-full md:max-w-custom-card-width hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 overflow-hidden shadow-lg",
